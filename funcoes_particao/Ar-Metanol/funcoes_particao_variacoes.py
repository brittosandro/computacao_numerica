...
def massa_reduzida(massa1, massa2):
    ...
    A função recebe os valores das massas em ua e converte para kg.
...
def convert_cm_to_joule(medida):
    '''
    Para converter a variável medida de cm-1 para j/mol (joule/mol) vamos
    utilizar o fator de conversão:

    1 cm-1 = 11,9627 j/mol
    '''
    fator_conversao = 11.9627
...
if __name__ == '__main__':
    ...
    for dado in dados:
        ...
        elif 'pressao' in dado:
            # pressão é definida em Pascal
    ...
    print('A massa de entrada do Monomero 1.')
    print(f'- m1 = {massa1} ua')
    print('A massa de entrada do Monomero 2.')
    print(f'- m2 = {massa2} ua')
    print('A massa reduzida do Dímero ou Pseudo-dímero.')
    mu = massa_reduzida(massa1, massa2)
    print(f'- mu = {mu} kg')
    print('A soma das massas do Dímero ou Pseudo-dímero.')
    M = soma_de_massas(massa1, massa2)
    print(f'- M = {M} kg')
    ...
    with open('energia_interna.csv', 'w') as f1, \
         ...
         for Temp in np.arange(Temp_inicial, Temp_final, incr_temp):
            ...
            ### Mcquarie
            # Nas linhas abaixo vamos definir as funções de partição definidas por Mcquarie
